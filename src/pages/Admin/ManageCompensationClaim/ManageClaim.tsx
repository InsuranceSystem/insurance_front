...
import '../../../App.css';
import ContractModal from './ResultModal';
...
import ClaimManageSideBar from '../../../Layouts/Sidabar/ClaimManageSideBar';
import axios from 'axios';

const ContractList = () => {
  const [selectedIsApproval, setSelectedIsApproval] = useState(false);
